...
const name = "ますかぷる";
const yomi = "Maskaple";
const description = "あなたの心に、ますかぷる割り込み！";
const imageId = "maskaple";
useSeoMeta({
	title: name,
	description,
	ogType: "profile",
	...
	<section class="tw:px-10 tw:xl:px-14 tw:py-14 tw:text-base">
		<section>
			<ProfileHead :catchphrase="description" :name="name" :yomi="yomi">
				...
				某中小SIer勤務で、1匹でインフラ全般担当中。<br/>
				「好奇心の赴くまま蒐集した知識や技術のコレクションを、皆々様と共有したい！」<br/>
				「どうしてもエンジニアは逸般人になりがちだから、一般と逸般の架け橋になりたい！」<br/>
		...
		<section>
			...
			<div class="tw:mb-28 tw:leading-loose tw:xl:max-w-screen-sm tw:xl:mx-auto">
				<ul class="tw:list-disc tw:ps-5">
					...
					<li>「声に出して読みたいIT用語」シリーズ(ショート動画)</li>
					<li>「明日からきっと役に立たない雑学」シリーズ(動画)</li>
				</ul>
				※猫又のきまぐれで増える場合があります。
			</div>
		</section>
