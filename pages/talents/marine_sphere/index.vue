...
const name = "まりんとすふぃあ";
const yomi = "marine&sphere";
const description = "ふたりが一緒なら、未知の技術も怖くない！";
useSeoMeta({
	title: name,
	description,
	ogType: "profile",
